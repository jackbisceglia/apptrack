export default function TOS() {
  const h1Styles = "font-bold text-xl pt-4";
  const h2Styles = "font-semibold text-lg pt-2";

  return (
    <div className="font-sen text-stone-800">
      <div className="px-4">
        <div className="mx-auto max-w-screen-sm">
          <h1 className={h1Styles}>Terms and Conditions</h1>
          <p>Last updated: July 19, 2022</p>
          <p>
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <h1 className={h1Styles}>Interpretation and Definitions</h1>
          <h2 className={h2Styles}>Interpretation</h2>
          <p>
          ...
          <h2 className={h2Styles}>Definitions</h2>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to AppTrack.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to AppTrack, accessible from{" "}
                <a
          ...
          <h1 className={h1Styles}>Acknowledgment</h1>
          <p>
          ...
          <h1 className={h1Styles}>Links to Other Websites</h1>
          <p>
          ...
          <h1 className={h1Styles}>Termination</h1>
          <p>
          ...
          <h1 className={h1Styles}>Limitation of Liability</h1>
          <p>
          ...
          <h1 className={h1Styles}>Governing Law</h1>
          <p>
          ...
          <h1 className={h1Styles}>Disputes Resolution</h1>
          <p>
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h1 className={h1Styles}>For European Union (EU) Users</h1>
          <p>
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </p>
          <h1 className={h1Styles}>United States Legal Compliance</h1>
          <p>
          ...
          <h1 className={h1Styles}>Severability and Waiver</h1>
          <h2 className={h2Styles}>Severability</h2>
          <p>
          ...
          <h2 className={h2Styles}>Waiver</h2>
          <p>
          ...
          <h1 className={h1Styles}>Translation Interpretation</h1>
          <p>
            These Terms and Conditions may have been translated if We have made
            them available to You on our Service. You agree that the original
            English text shall prevail in the case of a dispute.
          </p>
          <h1 className={h1Styles}>Changes to These Terms and Conditions</h1>
          <p>
